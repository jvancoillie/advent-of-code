...
{
    protected static int $testPart1Expected = 26;
    protected static int $testPart2Expected = 61229;

    protected static int $part1Expected = 274;
    protected static int $part2Expected = 1012089;
