...
{
    protected static int $testPart1Expected = 150;
    protected static int $testPart2Expected = 900;

    protected static int $part1Expected = 1694130;
    protected static int $part2Expected = 1698850445;
